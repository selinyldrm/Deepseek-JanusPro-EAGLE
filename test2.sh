#!/bin/bash
#SBATCH --exclusive
#SBATCH --job-name=base-llamagen        # Name of the job
#SBATCH --output=base-5k-%j.log            # Output log file
#SBATCH --error=base-5k-%j.log              # Error log file
...
python3  main.py generate_images --model anole  --model_type base  --model_path /work1/deming/shared/llamagen/LlamaGen-T2I-2   --output_dir /work1/deming/shared/llamagen/base-mi300  --temperature 1  --top_k 2000 --top_p 1.0  --cfg 3.0 --prompt MSCOCO2017Val --num_images 5000 --multigpu 