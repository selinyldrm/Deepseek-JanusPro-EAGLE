...
python3 main.py generate_train_data --model lumina_mgpt --data_path /work1/deming/shared/lumina/relaion-tokenized --output_dir /work1/deming/shared/lumina/training-data  --start 452854 --end 486207