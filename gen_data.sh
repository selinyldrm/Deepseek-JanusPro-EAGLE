...
python3 main.py generate_train_data --model januspro --data_path /work1/deming/shared/Janus-Pro-Training-Data/ --output_dir /work1/deming/shared/Janus-Pro-Training-Data/training-data  --start 30000 --end 60000