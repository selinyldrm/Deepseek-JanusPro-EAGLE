...
# cd traineagle3
# ./run_training.sh
accelerate launch -m entrypoints.train_drafter.main --model llamagen2 --base_path  /work1/deming/shared/llamagen/LlamaGen-T2I-2 --config_path /work1/deming/seliny2/LANTERN/traineagle3/config_llamagen.json  --data_dir /work1/deming/shared/llamagen/training-data-eagle3_eagle3 --save_dir /work1/deming/shared/llamagen/llamagen2-eagle3-fixedbase-length1 --bs 8 --save_freq 2