#!/bin/bash
#SBATCH --exclusive
#SBATCH --job-name=train-janus         # Name of the job
#SBATCH --output=train-janus%j.log            # Output log file
#SBATCH --error=train-janus%j.log              # Error log file
...
python3 main.py train_drafter --model januspro --base_path /work1/deming/shared/Janus-Pro-7B --config_path /work1/deming/seliny2/LANTERN/data/configs/januspro_config.json --data_dir /work1/deming/shared/Janus-Pro-Training-Data/training-data --save_dir /work1/deming/shared/Eagle-Janus-Pro