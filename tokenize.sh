...
python3 main.py extract_code --model llamagen2 --data_path /work1/deming/shared/relaion-coco --output_dir /work1/deming/shared/relaion-coco-tokenized --start 588043 --end 600000