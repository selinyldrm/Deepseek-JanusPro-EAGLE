...
def run_train_drafter(args):
    ...
    ckpt_path = "/work1/deming/shared/llamagen/llamagen2-eagle3-lmheadtrained-embed-condidx-attnfixed-7ablated/llamagen2_lr0.0001_p_w0.1_bsz8_gradacc_1_epochs20_length1_mscoco2017train30k/state_10/model.safetensors"
