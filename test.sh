...
#SBATCH --time=6:30:00                # Max runtime (HH:MM:SS)
...
python3  main.py generate_images --model lumina_mgpt  --model_type eagle  --model_path /work1/deming/shared/lumina/Lumina-mGPT-7B-768/  --drafter_path /work1/deming/shared/lumina/LANTERN-Lumina-mGPT-7B-768/  --output_dir /work1/deming/shared/lumina/draft-based-interstep/intra0.9-kl0.85-inter-combined-0.625  --temperature 1  --top_k 2000 --top_p 1.0  --cfg 3.0 --lantern --static_tree --tree_choice naive_extend_57 --prompt MSCOCO2017Val --multigpu --s_idx 4000 --e_idx 5000