...
# python3  main.py generate_images --model llamagen2  --model_type eagle2  --model_path /work1/deming/shared/llamagen/LlamaGen-T2I-2/ --drafter_path /work1/deming/shared/llamagen/trained-model-temp/llamagen2_lr0.0001_p_w0.1_bsz4_gradacc_1_epochs20_mscoco2017train30k/state_20  --output_dir /work1/deming/shared/llamagen/eagle2-results/loss-scaled/10levels-drifting-withrecovery-0.9-0.625-kl4.0  --temperature 1  --top_k 2000 --top_p 1.0  --cfg 3.0 --lantern --lantern_k 10 --lantern_delta 3.0  --static_tree --tree_choice naive_extend_10lev   --prompt MSCOCO2017Val --multigpu > 10levels-drifting-withrecovery-merging-0.9-0.625-kl4.0.txt   2>&1
python3  main.py generate_images --model llamagen2  --model_type eagle2  --model_path /work1/deming/shared/llamagen/LlamaGen-T2I-2/ --drafter_path /work1/deming/shared/llamagen/trained-model-temp/llamagen2_lr0.0001_p_w0.1_bsz4_gradacc_1_epochs20_mscoco2017train30k/state_20  --output_dir /work1/deming/shared/llamagen/eagle2-results/context-aware/windowed-merging  --temperature 1  --top_k 2000 --top_p 1.0  --cfg 3.0 --lantern --lantern_k 10 --lantern_delta 3.0  --static_tree --tree_choice naive_extend_57   --prompt MSCOCO2017Val  --multigpu > /work1/deming/shared/llamagen/eagle2-results/context-aware/windowed-solution.txt  2>&1
python3  main.py generate_images --model lumina_mgpt  --model_type eagle  --model_path /work1/deming/shared/lumina/Lumina-mGPT-7B-768/  --drafter_path /work1/deming/shared/lumina/LANTERN-Lumina-mGPT-7B-768   --output_dir /work1/deming/shared/lumina/window-based/  --temperature 1  --top_k 2000 --top_p 1.0  --cfg 3.0 --lantern --lantern_k 10 --lantern_delta 3.0  --static_tree --tree_choice naive_extend_57   --prompt MSCOCO2017Val --multigpu  > /work1/deming/shared/lumina/window-based/windowed-solution.txt  2>&1