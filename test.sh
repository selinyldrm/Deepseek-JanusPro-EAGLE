...
python3  main.py generate_images --model anole  --model_type base  --model_path /work1/deming/shared/anole/Anole-7b-v0.1-hf/   --output_dir /work1/deming/shared/anole/base-model  --temperature 1  --top_k 2000 --top_p 1.0  --cfg 3.0 --prompt MSCOCO2017Val --num_images 5000 --multigpu 